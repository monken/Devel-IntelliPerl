# This Makefile is for the Devel::IntelliPerl extension to perl.
#
...
#     ABSTRACT => q[Auto-completion for Perl]
#     AUTHOR => q[Moritz Onken <onken@netcubed.de>]
#     DIR => []
#     DISTNAME => q[Devel-IntelliPerl]
#     NAME => q[Devel::IntelliPerl]
#     NO_META => q[1]
#     PL_FILES => {  }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Devel/IntelliPerl.pm
...
TO_INST_PM = lib/.DS_Store \
	lib/Devel/.DS_Store \
	lib/Devel/IntelliPerl.pm \
	lib/Devel/IntelliPerl/Editor.pm \
	lib/Devel/IntelliPerl/Editor/TextMate.pm

PM_TO_BLIB = lib/Devel/IntelliPerl/Editor.pm \
	blib/lib/Devel/IntelliPerl/Editor.pm \
	lib/Devel/IntelliPerl.pm \
	blib/lib/Devel/IntelliPerl.pm \
	lib/Devel/.DS_Store \
	blib/lib/Devel/.DS_Store \
	lib/.DS_Store \
	blib/lib/.DS_Store \
	lib/Devel/IntelliPerl/Editor/TextMate.pm \
	blib/lib/Devel/IntelliPerl/Editor/TextMate.pm
...
DISTVNAME = Devel-IntelliPerl-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Devel/IntelliPerl.pm $(INST_MAN3DIR)/Devel::IntelliPerl.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Auto-completion for Perl</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Moritz Onken &lt;onken@netcubed.de&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Devel/IntelliPerl/Editor.pm blib/lib/Devel/IntelliPerl/Editor.pm \
	  lib/Devel/IntelliPerl.pm blib/lib/Devel/IntelliPerl.pm \
	  lib/Devel/.DS_Store blib/lib/Devel/.DS_Store \
	  lib/.DS_Store blib/lib/.DS_Store \
	  lib/Devel/IntelliPerl/Editor/TextMate.pm blib/lib/Devel/IntelliPerl/Editor/TextMate.pm 
